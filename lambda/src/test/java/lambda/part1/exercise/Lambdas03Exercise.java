...
public class Lambdas03Exercise {
    ...
    public void generic2() {
        final GenericProduct<Integer> prod = (a,i) -> a*i; // Use expression lambda//todo
    ...
    @Test
    public void strSum() {
        final GenericProduct<String> prod = Lambdas03Exercise::stringProd; // use stringProd; //todo
